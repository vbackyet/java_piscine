...
public class MessagesRepositoryJdbcImpl implements MessagesRepository {
	...
	{
		String query = "INSERT into chat.msgs (room_id, sender, message)" +
		"VALUES" + "( " + message.getChatroom().getId() +"," + message.getAuthor().getUSER_ID() + ", '" + 
		message.getText() + "'  );";
		...
		{
			new NotSavedSubEntityException(e);
		}
